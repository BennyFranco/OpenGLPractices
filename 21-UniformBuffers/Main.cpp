...
int main()
{
    ...
    Shader shaderRed    ("../shaders/cube.vs", "../shaders/red.fs");
    Shader shaderGreen  ("../shaders/cube.vs", "../shaders/green.fs");
    Shader shaderBlue   ("../shaders/cube.vs", "../shaders/blue.fs");
    Shader shaderYellow ("../shaders/cube.vs", "../shaders/yellow.fs");
